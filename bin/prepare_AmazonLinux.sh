...
sudo yum update -y 
pip install --ignore-installed future grpcio scipy portpicker boto3 awscli enum34 mock requests wheel six h5py keras_applications keras_preprocessing keras
sudo pip2.7 install --ignore-installed future grpcio scipy portpicker boto3 awscli enum34 mock requests wheel six h5py keras_applications keras_preprocessing keras
pip install numpy==1.15.0
sudo pip2.7 install numpy==1.15.0
pip install keras_preprocessing keras_applications --user
sudo pip2.7 install keras_preprocessing keras_applications --user
