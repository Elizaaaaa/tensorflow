...
TF_BUILD_FLAGS="--verbose_failures --copt=-msse4.1 --copt=-msse4.2 --copt=-mavx2 --copt=-mavx --copt=-mfma --cxxopt=-D_GLIBCXX_USE_CXX11_ABI=0 --copt=-DEIGEN_USE_VML --crosstool_top=//third_party/toolchains/preconfig/ubuntu16.04/gcc7_manylinux2010:toolchain"
