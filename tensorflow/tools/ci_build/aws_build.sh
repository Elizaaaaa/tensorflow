...
if [[ "${CONTAINER_TYPE}" == gpu* ]]; then
  TF_BUILD_FLAGS="--config=cuda ${TF_BUILD_FLAGS} --crosstool_top=//third_party/toolchains/preconfig/ubuntu16.04/gcc7_manylinux2010-nvcc-cuda10.0:toolchain"
else
  TF_BUILD_FLAGS="${TF_BUILD_FLAGS} --crosstool_top=//third_party/toolchains/preconfig/ubuntu16.04/gcc7_manylinux2010:toolchain"
fi
